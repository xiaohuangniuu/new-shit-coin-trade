...
function IndexPage(){
  ...
  const generateProofThree = async () => {
    if (contractObj && walletAddress && web3) {
      ...
      <Container>
        <chakra.div  h="4.5rem" display={'flex'}  alignItems="center">
          {walletAddress?<chakra.div fontWeight={"500"} fontStyle={"italic"}>
            ...
            <Button   _focus={{ boxShadow: "none",textDecoration:"none",border:'none' }}
                      _hover={{  boxShadow: "none",textDecoration:"none",border:'none',color: "purple.500" }}
                      color="gray.500" onClick={connectWallet}>Connect Metamask</Button>}

        </chakra.div>
        <Link as={RouterLink} to={`/detail/0`}>
          <chakra.div mb={5}  boxShadow={"2px 2px 8px 3px rgb(58 58 58 / 50%)"} border={"2px solid purple"} p={5} borderRadius={"0.5rem"}>
            <Heading   as='h4' size='md'>Doge king</Heading>
            <chakra.div mt={2} lineHeight={"24px"} fontWeight={"400"}>
        ...
        <Link as={RouterLink} to={`/detail/0`}>
        <chakra.div  boxShadow={"0 3px 8px 2px rgb(58 58 58 / 50%)"} border={"2px solid purple"} p={5} borderRadius={"0.5rem"}>
          <Heading  as='h4' size='md'>Doge king</Heading>
          <chakra.div mt={2} fontWeight={"400"}>
            Featured: Hide transactions involving tokens flagged as having poor reputation with
            Featured: Hide transactions involving tokens flagged as having poor reputation with
            Featured: Hide transactions involving tokens flagged as having poor reputation with
          </chakra.div>
